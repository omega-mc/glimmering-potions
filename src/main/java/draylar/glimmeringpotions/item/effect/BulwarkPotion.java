...
public class BulwarkPotion extends EffectPotionItem {
    ...
    public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
        ...
        tooltip.add(new TranslatableText("glimmeringpotions.tooltip.bulwark_1").formatted(Formatting.GRAY));
        tooltip.add(new TranslatableText("glimmeringpotions.tooltip.bulwark_2").formatted(Formatting.GRAY));
    }
}